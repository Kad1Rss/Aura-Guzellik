  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        İLETİŞİM:
        📲 WhatsApp & Randevu Birimi: https://api.whatsapp.com/send/?phone=905466183062&text=Merhaba%20randevu%20istiyorum`,
        thinkingConfig: { thinkingBudget: 0 }, 
      },
    });

    return response.text || "Şu an bağlantıda bir yoğunluk var, doğrudan merkezimize yazabilirsin 📞 0546 618 30 62";
  } catch (error) {
    console.error("Gemini API Error:", error);
    return "Küçük bir teknik aksaklık oldu ama randevu hattımız seni bekliyor 📞 0546 618 30 62";
  }
};
