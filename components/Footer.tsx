        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 border-b border-rose-800/50 pb-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
               <a href={INSTAGRAM_LINK} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-rose-900 flex items-center justify-center hover:bg-rose-700 transition-colors text-white">
                 <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
               </a>
               <a href={WHATSAPP_LINK} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-green-600 flex items-center justify-center hover:bg-green-700 transition-colors text-white">
          ...
          <div className="md:col-span-2 bg-rose-900/50 p-6 rounded-2xl">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-3 text-rose-200/90">
               <div className="flex justify-between border-b border-rose-800 pb-1"><span>Pazartesi</span> <span>09:00 - 22:00</span></div>
               <div className="flex justify-between border-b border-rose-800 pb-1"><span>Salı</span> <span>09:00 - 22:00</span></div>
               <div className="flex justify-between border-b border-rose-800 pb-1"><span>Çarşamba</span> <span>09:00 - 22:00</span></div>
               <div className="flex justify-between border-b border-rose-800 pb-1"><span>Perşembe</span> <span>09:00 - 22:00</span></div>
               <div className="flex justify-between border-b border-rose-800 pb-1"><span>Cuma</span> <span>09:00 - 22:00</span></div>
               <div className="flex justify-between border-b border-rose-800 pb-1"><span>Cumartesi</span> <span>09:00 - 22:00</span></div>
               <div className="flex justify-between col-span-2 font-bold text-white mt-2 bg-rose-800/50 p-2 rounded">
                  <span>Pazar</span> 
