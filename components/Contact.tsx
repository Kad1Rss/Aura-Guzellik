      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col lg:flex-row">
          ...
          <div className="lg:w-2/3 relative h-[400px] lg:h-auto bg-gray-200">
             <iframe 
               src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d187.42245296849276!2d27.964314299999998!3d41.270577599999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14b527cdf79cfc9f%3A0xefbf3b8b995d319f!2sAura%20G%C3%BCzellik%20Merkezi!5e0!3m2!1str!2str!4v1765040156192!5m2!1str!2str"
               width="100%" 
               height="100%" 
               style={{border:0}} 
